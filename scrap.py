...
# Constantes
NOTEBOOKS_ML = 'https://listado.mercadolibre.com.ar/notebooks-usadas#D[A:notebooks%20usadas]'
...
class ScrapMercadoLibre:
    ...
    def notebooks_usadas(self):
        ...
        nombres = soup.find_all('h2', class_= 'ui-search-item__title shops__item-title')
